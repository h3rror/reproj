...
% D2(1,[1 2]) = [-1 1]; % dx/dxi(0,t) = 0 [ x(0)-x(-1) = 0 ]
% D2(end,[end-1 end]) = [1 -1]; % dx/dxi(1,t) = 0 [ x(0)-x(-1) = 0 ]
% D2(1,[1 2]) = [-2 2]; % dx/dxi(0,t) = 0 [ x(1)-x(-1) = 0 ]
D2(end,[end-1 end]) = [2 -2]; % dx/dxi(1,t) = 0 [ x(1)-x(-1) = 0 ]
D2(1,:) = 0; % dx.dt(0,t) = u
% D2(end,end) = -1/dt; % dx/dt = 0 BC / Dirichlet BC

A1 = D2 + I;
A1(1,1) = -1/dt; % dx/dt = 0 BC / Dirichlet BC

K = vecwise_kron(I)';
BC = eye(N);
BC(1,:) = 0; % dx/dt = 0 BC / Dirichlet BC


% A3 = - BC*K*kron(I,K*kron(I,I));
...
f = @(x,u) F1(x) + F2(x,x) + F3(x,x,x) + B*u;
