...
syms xis_ mu_;
k0_(xis_,mu_) = exp(-.5/pi*(xis_-mu_).^2)+1;
...
savefig("figures_gaussian/operator_errors.fig")
exportgraphics(gcf,"figures_gaussian/operator_errors.pdf")
...
set(gca, 'YScale', 'log')
grid on
legend("show","Location","east","Interpreter","latex","FontSize",12)
box on
set(gcf,'Position',[100 100 500 500])

savefig("figures_gaussian/condition_numbers.fig")
...
savefig("figures_gaussian/operator_errors_evaluated.fig")
exportgraphics(gcf,"figures_gaussian/operator_errors_evaluated.pdf")
...
savefig("figures_gaussian/rom_state_errors.fig")
